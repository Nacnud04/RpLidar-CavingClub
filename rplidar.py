...
def _process_scan(raw, currentTime):
    ...
    return new_scan, quality, angle, distance, currentTime
...
class RPLidar(object):
    ...
    def iter_measures(self, scan_type='normal', max_buf_meas=3000):
        ...
        while True:
            ...
            if self.scanning[2] == 'normal':
                ...
                yield _process_scan(raw, currentTime)
    ...
    def iter_scans(self, scan_type='normal', max_buf_meas=3000, min_len=5):
        ...
        for new_scan, quality, angle, distance, currentTime in iterator:
            if new_scan:
                if len(scan_list) > min_len:
                    yield scan_list
                scan_list = []
            if distance > 0:
                scan_list.append((currentTime, quality, angle, distance))
